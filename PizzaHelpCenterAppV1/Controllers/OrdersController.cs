...
using PizzaHelpCenterAppV1.Models;
...
namespace PizzaHelpCenterAppV1.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        [Authorize(Roles = "Admin")]
        public ActionResult Create([Bind(Include = "OrderId,Name,PizzaSize,Quantity,PizzaPrice,TimeOFOrderCreated,CustomerId")] Order order)
        {
